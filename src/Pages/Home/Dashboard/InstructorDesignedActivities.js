...
const InstructorDesignedActivities = () => {
    ...
    useEffect(() => {
        ...
        axios.get("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/home/instructors").then((response) => {
            if (response.data) {
                Object.entries(response.data).forEach(([key, value]) => {
                    (async () => {
                        //for each instructor retrieves a list of activities created by them.
                        await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/home", { UserId: parseInt(value.id) }).then((response) => {
                            if (response.data) {
                                Object.entries(response.data).forEach(([key2, value2]) => {
                                    ...
                                    if (value2.Published !== false) {
                                        (async () => {
                                            ...
                                            await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/byId/${parseInt(value2.ActivityOneId)}`).then((response) => {
                                                if (response.data) {
    ...
    const handleCopyTemplate = async (data) => {
        ...
        try {
            ...
            if (data.ActivityOneId) {
                ...
                const response = await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/byId/${data.ActivityOneId}`);
                ...
                if (ActivityOneData !== null) {
                    ...
                    const ActivityOneIdResponse = await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/fromtemplate", data);
            ...
            if (data.ActivityTwoId) {
                ...
                const response2 = await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/byId/${data.ActivityTwoId}`);
                ...
                if (ActivityTwoData !== null) {
                    ...
                    const ActivityTwoIdResponse = await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo", data);
            ...
            if (data.ActivityThreeId) {
                ...
                const response3 = await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree/byId/${data.ActivityThreeId}`);
                ...
                if (ActivityThreeData !== null) {
                    ...
                    const ActivityThreeIdResponse = await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree", data);
            ...
            if (data.ActivityFourId) {
                ...
                const response4 = await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/byId/${data.ActivityFourId}`);
                ...
                if (ActivityFourData !== null) {
                    ...
                    const ActivityFourIdResponse = await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour", data);
            ...
            if (data.ActivityFiveId) {
                ...
                const response5 = await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/byId/${data.ActivityFiveId}`);
                ...
                if (ActivityFiveData !== null) {
                    ...
                    const ActivityFiveIdResponse = await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive", data);
            ...
            if (data.ActivitySixId) {
                ...
                const response6 = await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix/byId/${data.ActivitySixId}`);
                ...
                if (ActivitySixData !== null) {
                    ...
                    const ActivitySixIdResponse = await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix", data);
            ...
            for (let i = 1; i <= 6; i++) {
                ...
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/studentlog/create`, logs_data);
            }
