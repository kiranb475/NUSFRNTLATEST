...
const CustomActivitiesInstructor = () => {
    ...
    useEffect(() => {
        axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/home", { UserId: UserId }).then((response) => {
            if (response.data) {
                Object.entries(response.data).forEach(([key, value]) => {
                    ...
                    (async () => {
                        ...
                        if (value.ActivityOneId !== null) {
                            await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/byId/${parseInt(value.ActivityOneId)}`)
                                .then((response) => {
                                    if (response.data) {
                                        activityOneUpdate = {
                        ...
                        if (value.ActivityTwoId !== null) {
                            await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/byId/${parseInt(value.ActivityTwoId)}`)
                                .then((response) => {
                                    if (response.data) {
                                        activityTwoUpdate = {
                                            ["label"]: response.data.label,
                        ...
                        if (value.ActivityThreeId !== null) {
                            await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree/byId/${parseInt(value.ActivityThreeId)}`)
                                .then((response) => {
                                    if (response.data) {
                                        activityThreeUpdate = {
                                            ["label"]: response.data.label,
                        ...
                        if (value.ActivityFourId !== null) {
                            await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/byId/${parseInt(value.ActivityFourId)}`)
                                .then((response) => {
                                    if (response.data) {
                                        activityFourUpdate = {
                                            ["label"]: response.data.label,
                        ...
                        if (value.ActivityFiveId !== null) {
                            await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/byId/${parseInt(value.ActivityFiveId)}`)
                                .then((response) => {
                                    if (response.data) {
                                        activityFiveUpdate = {
                                            ["label"]: response.data.label,
                        ...
                        if (value.ActivitySixId !== null) {
                            await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix/byId/${parseInt(value.ActivitySixId)}`)
                                .then((response) => {
                                    if (response.data) {
                                        activitySixUpdate = {
                                            ["label"]: response.data.label,
    ...
    const handleSubmit = async (key, value) => {
        ...
        try {
            ...
            if (activity1Id) {
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/home/${activity1Id}`,
                    {
                ...
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone",
                    {
                        transcriptEditable: value.activityOne.notEditableTranscript,
                        label: activityOneLabel,
                        instruction: activityOneInstruction,
            ...
            if (activity2Id) {
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/home/${activity2Id}`,
                    {
                ...
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/",
                    {
                        id: activityId,
                        content: {
                            predefinedHighlighting: value.activityTwo.highlightingNotAllowed,
            ...
            if (activity3Id) {
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree/home/${activity3Id}`,
                    {
                ...
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree",
                    {
                        id: activityId,
                        content: {
                            MLModel: value.activityThree.MLModel,
            ...
            if (activity4Id) {
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/home/${activity4Id}`,
                    {
                ...
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/",
                    {
                        id: activityId,
                        content: {
                            label: activityFourLabel,
            ...
            if (activity5Id) {
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/home/${activity5Id}`,
                    {
                ...
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/`,
                    {
                        id: activityId,
                        content: {
                            MLClusters: value.activityFive.allowMLClustering,
            ...
            if (activity6Id) {
                ...
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix/home/${activity6Id}`,
                    {
                ...
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix/",
                    {
                        id: activityId,
                        content: {
                            label: activitySixLabel,
            ...
            await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/home/update-published-status/${activityId}`,
                { Published: true });
            ...
            for (let i = 1; i <= 6; i++) {
                ...
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/instructorlog/create`, logs_data);
            }
    ...
    const handleRemovalStudentsInterface = async (value) => {
        ...
        try {
            ...
            await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/home/update-published-status/${value.activityId}`, { Published: false });
    ...
    const handleDelete = async (value) => {
        ...
        try {
            ...
            await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/home/delete-activity",
                { activityId: value.activityId })

            //deletes activity one id
            await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/delete-activity",
                { activityId: value.activityOne.key })

            //deletes activity two id
            if (value.activityTwo.key) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/delete-activity",
                    { activityId: value.activityTwo.key })
            }

            //deletes activity three id
            if (value.activityThree.key) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree/delete-activity",
                    { activityId: value.activityThree.key })
            }

            //deletes activity four id
            if (value.activityFour.key) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/delete-activity",
                    { activityId: value.activityFour.key })
            }

            //deletes activity five id
            if (value.activityFive.key) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/delete-activity",
                    { activityId: value.activityFive.key })
            }

            //deletes activity six id
            if (value.activitySix.key) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix/delete-activity",
