...
const CustomActivitiesStudent = () => {
            ...
            if (response.data) {
                Object.entries(response.data).forEach(([key, value]) => {
                    (async () => {
                        ...
                        await axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/byId/${parseInt(value.ActivityOneId)}`).then((response) => {
                            if (response.data) {
    ...
    const handleDelete = async (value) => {
        ...
        try {
            ...
            await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/home/delete-activity", { activityId: value.id })

            //deletes activity one id
            await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/delete-activity", { activityId: value.ActivityOneId })

            //deletes activity two id
            if (value.ActivityTwoId) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/delete-activity", { activityId: value.ActivityTwoId })
            }

            //deletes activity three id
            if (value.ActivityThreeId) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree/delete-activity", { activityId: value.ActivityThreeId })
            }

            //deletes activity four id
            if (value.ActivityFourId) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/delete-activity", { activityId: value.ActivityFourId })
            }

            //deletes activity five id
            if (value.ActivityFiveId) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/delete-activity", { activityId: value.ActivityFiveId })
            }

            //deletes activity six id
            if (value.ActivitySixId) {
                await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix/delete-activity", { activityId: value.ActivitySixId })
            }
