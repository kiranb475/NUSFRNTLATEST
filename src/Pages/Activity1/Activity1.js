...
const Activity1 = () => {
  ...
  useEffect(() => {
    ...
    if (id) {
      axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/byId/${id}`)
        .then((response) => {
          if (response.data) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (id) {
      ...
      await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/byId/${id}`, final_data);

      if (newChain) {

        //deletes activity id of future activities
        await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/byId/${sessionStorage.getItem("ActivitiesId")}/new-chain`);
      ...
      await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone", final_data)
        .then((response) => {
