...
const Activity3 = () => {
    ...
    useEffect(() => {
        ...
        if (id) {
            axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree/byId/${id}`).then((response) => {
                if (response.data !== null) {
                    ...
                    if (response.data.lastAuthored === "instructor") {
                        axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/byId/${sessionStorage.getItem("ActivityTwoId")}`).then((response) => {
                            if (response.data !== null) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (id && sessionStorage.getItem("new-chain") !== "true") {
            ...
            await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree/byId/${id}`, data);

            if (newChain) {

                //deletes activity id for future activities
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree/byId/${sessionStorage.getItem("ActivitiesId")}/new-chain`);
            ...
            await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree", data).then((response) => {
        ...
        if (!instructor) {
            ...
            //update student logs
            await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/studentlog/create`, data);
        } else {
            let data = {
                DateTime: Date.now(),
            ...
            await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/instructorlog/create`, data);
        }
