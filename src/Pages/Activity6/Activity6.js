...
const Act6 = () => {
  ...
  useEffect(() => {
    ...
    if (id) {
      axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix/byId/${id}`)
        .then((response) => {
          ...
          if (response.data.lastAuthored === "instructor") {
            axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/byId/${sessionStorage.getItem("ActivityFiveId")}`)
              .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (id && sessionStorage.getItem("new-chain") !== "true") {
      ...
      await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix/byId/${id}`, data);
      event = "Update";

    } else {

      //create new entry of activity six
      await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitysix", data)
        .then((response) => {
    ...
    Object.entries(summary_data).map(([key, value]) => {
      axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/summary/create`, value);
    });
