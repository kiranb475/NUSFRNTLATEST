...
const Act5 = () => {
    ...
    useEffect(() => {
        ...
        if (id) {
            axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/byId/${id}`)
                .then((response) => {
                    if (response.data !== null) {
                        ...
                        if (response.data.lastAuthored === "instructor") {
                            axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/byId/${sessionStorage.getItem("ActivityFourId")}`)
                                .then((response) => {
                                    if (response.data !== null) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (id && sessionStorage.getItem("new-chain") !== "true") {
            ...
            await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/byId/${id}`, data)

            if (newChain) {

                //deletes activity id for future activities
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive/byId/${sessionStorage.getItem("ActivitiesId")}/new-chain`);
            ...
            await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfive", data)
                .then((response) => {
