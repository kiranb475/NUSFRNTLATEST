...
const Activity2 = () => {
    ...
    useEffect(() => {
        ...
        if (id) {
            ...
            axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/byId/${id}`)
                .then((response) => {
                    if (response.data !== null) {
                        ...
                        if (Object.entries(response.data.content).length === 0 || sessionStorage.getItem("setNotEditableTranscript") !== "true") {
                            ...
                            axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityone/byId/${sessionStorage.getItem("ActivityOneId")}`)
                                .then((response) => {
                                    if (response.data !== null) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (id && sessionStorage.getItem("new-chain") !== "true") {
            ...
            await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/byId/${id}`, data);

            if (newChain) {

                //deletes activity id for future activities
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo/byId/${sessionStorage.getItem("ActivitiesId")}/new-chain`);
            ...
            await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitytwo", data)
                .then((response) => {
