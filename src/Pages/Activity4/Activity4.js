...
const Activity4 = () => {
    ...
    useEffect(() => {
        ...
        if (id) {
            axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/byId/${id}`).then((response) => {
                ...
                if (response.data.lastAuthored === "instructor") {
                    axios.get(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activitythree/byId/${sessionStorage.getItem("ActivityThreeId")}`).then((response) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (id && sessionStorage.getItem("new-chain") !== "true") {
            ...
            await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/byId/${id}`, data);

            if (newChain) {

                //deletes activity id for future activities
                await axios.post(`https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour/byId/${sessionStorage.getItem("ActivitiesId")}/new-chain`);
            ...
            await axios.post("https://nusbackend-hndkeggkdwenfjgy.eastus-01.azurewebsites.net/activityfour", data).then((response) => {
